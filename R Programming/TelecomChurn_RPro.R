...
predicted <- as.numeric(prediction_mtree_1)
predicted <- if_else(predicted == 2, 1, 0)
accuracy_score_mtree_1 <- accuracy(actual, predicted)
precision_score_mtree_1 <- precision(actual, predicted)
accuracy_score_mtree_1
precision_score_mtree_1 
#ROC Curve
ROCit_base <- rocit(score=predicted, class=actual)
plot(ROCit_base)
recall_score_mtree_1 <- recall(actual, predicted)
auc_score_mtree_1 <- auc(actual, predicted)
...
predicted <- as.numeric(prediction_svc_1)
predicted <- if_else(predicted == 2, 1, 0)
accuracy_score_svc_1 <- accuracy(actual, predicted)
precision_score_svc_1 <- precision(actual, predicted)
accuracy_score_svc_1
precision_score_svc_1 
#ROC Curve
ROCit_base <- rocit(score=predicted, class=actual)
plot(ROCit_base)
recall_score_svc_1 <- recall(actual, predicted)
auc_score_svc_1 <- auc(actual, predicted)
...
predicted <- as.numeric(prediction_rf_1)
predicted <- if_else(predicted == 2, 1, 0)
accuracy_score_rf_1 <- accuracy(actual, predicted)
precision_score_rf_1 <- precision(actual, predicted)
accuracy_score_rf_1
precision_score_rf_1 
#ROC Curve
ROCit_base <- rocit(score=predicted, class=actual)
plot(ROCit_base)
recall_score_rf_1 <- recall(actual, predicted)
auc_score_rf_1 <- auc(actual, predicted)
